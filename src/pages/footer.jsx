const Footer = () => {
    return ( 
      <footer className="bg-gradient-to-br from-primary to-secondry mt-20 text-white py-12 px-4 font-sans tracking-wide">
      <div className="text-center">
        ...
        <p className="text-base">© Naji Ali. All rights reserved.</p>
      </div>
    </footer>
     );
}
